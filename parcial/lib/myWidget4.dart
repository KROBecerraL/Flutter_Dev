...
class FavoritoGridView extends StatefulWidget {
  const FavoritoGridView({Key? key}) : super(key: key);

  @override
  _FavoritoGridViewState createState() => _FavoritoGridViewState();
}

class _FavoritoGridViewState extends State<FavoritoGridView> {
