...
class ArticuloListView extends StatefulWidget {
  const ArticuloListView({Key? key}) : super(key: key);

  @override
  _ArticuloListViewState createState() => _ArticuloListViewState();
}

class _ArticuloListViewState extends State<ArticuloListView> {
